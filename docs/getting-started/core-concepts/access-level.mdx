...
description: Learn how Visual KPI ensures data security through object-level access controls, enabling tailored user permissions for secure and efficient data visualization.
tags: ['core-concepts', 'security', 'object-level-security', 'access-levels', 'user-groups']
---

<head>
  <title>Access Levels</title>
  <meta name="keywords" content="Visual KPI, access levels, security, object-level security, data security, user permissions, user groups, KPI permissions, tailored security, Visual KPI Designer"/>
</head>
...
Now that you have covered all the core concepts of the Visual KPI, it's time to check the specific content for your role. If you aren't familiar with the documentation organization, access the [How to Use the Documentation](/how-to-use-the-documentation) guide. Otherwise, you can see the specific section for each use type:
