...
tags: ['administrator', 'design', 'end-user', 'setup', 'reference-guides', 'faq', 'core-concepts']
---
...
It is important to note that the documentation for Visual KPI has been organized to serve the three types of users - each with its own section and specific content to assist them in using the available tools. However, we suggest starting with the [Visual KPI Core Concepts](/core-concepts) to gain a general understanding of the platform's functionality.

After reading the core concepts, each user can continue to their specific section:

- [Setup and Administration](/setup-and-administration): This section was planned to help the Administrator install Visual KPI, create and start using interfaces, and show how to use the automation functionalities to import existing KPIs from your system into Visual KPI.
- [Visual KPI Design](/visual-kpi-designer/overview): Designers find in this section the necessary content to configure Visual KPI and create KPIs, Charts, Tables, and Groups.
- [End User](/end-user/overview): The guide for end users to learn how to use and take advantage of Visual KPI is available in this section.
...
- [Reference guides](/references): These provide detailed documentation and information for users to refer to when they need in-depth knowledge or assistance regarding specific Visual KPI functionalities.
- [Frequently Asked Questions (FAQs)](/faqs): This section contains answers to common questions and issues that users may encounter while using Visual KPI, offering quick solutions.
- [Glossary](/glossary): Explore a list of key terms and their definitions to clarify technical jargon and terminology used within Visual KPI.

## What's Next?

If you are new to Visual KPI, we recommend accessing the [Visual KPI Core Concepts](/core-concepts) page first. If you are already familiar with Visual KPI, you can proceed to one of the pages described above, depending on your needs.
