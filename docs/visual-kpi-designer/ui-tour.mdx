...
title: UI Tour
slug: ui-tour
description: Explore the UI of Visual KPI Designer, an Excel-based tool for configuring and managing KPIs, charts, and tables. Learn about its toolbar, worksheets, and how to navigate and use its features effectively.
tags: ['designer', 'settings', 'data-management', 'charts', 'tables']
---

<head>
  <title>UI Tour</title>
  <meta name="keywords" content="UI Tour, Excel Add-on, KPI Configuration, Toolbar, Worksheets, Data Management, Charts, Tables, Site Settings"/>
</head>
