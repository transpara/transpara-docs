...
tags: ['settings', 'profiles', 'dashboards', 'alerts', 'designer']
---

<head>
  <title>Settings Overview</title>
  <meta name="keywords" content="settings, site configuration, profiles, dashboards, alerts, contacts, advanced settings, Visual KPI Designer"/>
</head>
...
<Callout type="info" title="Default Range and User Customization">
