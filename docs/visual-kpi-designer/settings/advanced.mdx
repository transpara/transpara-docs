...
title: Advanced
slug: advanced
description: Learn how to configure advanced settings in Visual KPI Designer, including interfaces, custom attributes, language options, navigation bar links, site rollups, and comment codes.
tags: ['settings', 'interfaces', 'designer']
---

<head>
  <title>Advanced Settings</title>
  <meta name="keywords" content="advanced settings, configure interfaces, manage custom attributes, set language options, create nav bar links, organize site rollups, use comment codes"/>
</head>
...
An Administrator must set up the interface before it appears in Visual KPI Designer. For more information on how to set up an interface, go to the [Admin guide for Interfaces Configuration](/setup-and-administration/interfaces/configuration).
</Callout>
