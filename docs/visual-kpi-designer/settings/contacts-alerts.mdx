...
description: Learn how to configure contacts and alert templates in Visual KPI Designer to manage notifications, customize alert behavior, and streamline KPI monitoring.
tags: ['settings', 'designer']
---

<head>
  <title>Contacts & Alerts</title>
  <meta name="keywords" content="contacts, alerts, alert templates, notification settings, configure contacts, manage alerts, notification timing, alert control, KPI alerts"/>
</head>
...
If some of the available parameters are unclear, you can refer to the [Contacts](/reference/visual-kpi-designer/site-settings/contacts) reference page.
...
1. Add a **Name** on the first blank row below the column headers.
2. Add a **Description** if appropriate.
3. Enter Alert Template configurations. See the [Alerts](/reference/visual-kpi-designer/site-settings/alerts) reference page for a detailed description of each option available.
