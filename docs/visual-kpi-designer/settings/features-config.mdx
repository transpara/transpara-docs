...
description: Configure the appearance, behavior, and advanced settings of your Visual KPI site, including website basics, KPI statuses, chart colors, and site-wide features.
tags: ['settings', 'designer']
---

<head>
  <title>Features & Configuration</title>
  <meta name="keywords" content="features config, website settings, KPI status, chart colors, Visual KPI, site configuration, customization, advanced settings"/>
</head>
