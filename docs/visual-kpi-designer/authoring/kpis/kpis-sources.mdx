...
slug: kpis-sources
description: Learn how to use parameters in Visual KPI Designer to combine and calculate data from multiple data sources, automate dynamic attributes, and enhance KPI visualization.
tags: ['kpis', 'data-integration', 'designer', 'real-time', 'data-sources']
---

<head>
  <title>Using Values from Multiple Data Sources</title>
  <meta name="keywords" content="multiple data sources, kpi parameters, visual kpi, dynamic attributes, data integration, data calculation, real-time data, visual kpi designer"/>
</head>
