...
title: Authoring
slug: overview
description: Learn how to configure objects like Groups, KPIs, Charts, Tables, and Trends in Visual KPI Designer, including detailed Info column settings for enhanced data visualization.
tags: ['designer', 'data-visualization']
---

<head>
  <title>Authoring</title>
  <meta name="keywords" content="authoring, visual kpi designer, kpi site, info column, kpi configuration, data visualization, kpi groups, charts, tables, trends, excel add-in"/>
</head>
...
<CardList cols={3}>
  <Card 
    title="Groups"
    link="/visual-kpi-designer/authoring/groups"
  />
  <Card 
    title="KPIs"
    link="/visual-kpi-designer/authoring/kpis"
  />
  <Card 
    title="Charts"
    link="/visual-kpi-designer/authoring/charts"
  />
  <Card 
    title="Tables"
    link="/visual-kpi-designer/authoring/tables"
  />
  <Card 
    title="Trends"
    link="/visual-kpi-designer/authoring/trends"
  />
</CardList>
