...
title: Tables
slug: tables
description: Learn how to create and configure tables in Visual KPI Designer, including defining attributes, linking to trends, and utilizing SQL-based data sources for dynamic data visualization.
tags: ['tables', 'designer', 'data-visualization', 'sql']
---

<head>
  <title>Tables</title>
  <meta name="keywords" content="tables, visual kpi designer, data visualization, table configuration, sql integration, maintenance log, shift report, dynamic groups, geolocation"/>
</head>
...
<Callout type="info" title="Working with Tables">
...
See a full list of all possible Table attributes in the [Tables Attributes & Keyword Reference](/reference/visual-kpi-designer/attributes-and-keywords/tables).
...
You can find more details about this feature in the [Info Column section](/visual-kpi-designer/authoring/overview#info-column).