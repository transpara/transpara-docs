...
description: Learn how to configure the Visual KPI Remote Context Service (RCS) with AF databases to automate the setup of Visual KPI, including Profile Groups, Dashboards, Widgets, and Attributes mapping.
tags: ['administrator', 'configuration', 'automation', 'rcs', 'remote-context-service']
---

<head>
  <title>RCS with AF Databases</title>
  <meta name="keywords" content="Visual KPI, Remote Context Service, RCS, AF databases, configuration, automation, dashboards, attributes mapping, profile groups, widgets"/>
</head>
...
<Callout type="info" title="Using Visual KPI Object IDs as References">
...
<Callout type="note" title="Nesting Visual KPI Attributes">
...
<Callout type="warning" title="Ignoring Visual KPI Properties">
...
<Callout type="info" title="Simplified Nested Keywords">
...
<Callout type="note" title="Attribute Mapping Keyword Reference">
