...
description: Step-by-step tutorial on using a SQL Remote Context Server (RCS) with Visual KPI to automate data visualization, including setup, database creation, and building dashboards for a fictitious mining company.
tags: ['sql', 'automation', remote-context-server', 'data-visualization', 'administrator']
---

<head>
  <title>SQL Tutorial</title>
  <meta name="keywords" content="SQL tutorial, Remote Context Server SQL, KPI automation, Visual KPI SQL, SQL RCS setup, mining data visualization, SQL database tutorial, ODBC configuration, RCS KPI tutorial, SQL for Visual KPI"/>
</head>
...
<Callout type="info" title="Downloading the Latest Visual KPI Software">
...
<Callout type="info" title="Global Setting vs Individual KPI Override">
...
<Callout type="note" title="Future Modifications Under Gear Icon">
...
### Execute the Sscript to Add Data
...
<Callout type="success" title="Ensuring Proper Setup">
...
<Callout type="info" title="Select SQL RC Service">
