...
description: Learn how to configure and use the Visual KPI Remote Context Service (RCS) with SQL databases for seamless automation and integration of data into Visual KPI.
tags: ['administrator', 'configuration', 'automation', 'rcs', 'remote-context-service', 'sql']
---

<head>
  <title>RCS with SQL Databases</title>
  <meta name="keywords" content="Visual KPI, Remote Context Service, RCS, SQL databases, ODBC, configuration, automation, data mapping, KPI attributes, SQL tutorial"/>
</head>
...
<Callout type="note" title="Changing Foreign System IDs">
...
- **[Groups Attributes & Keywords Reference Table](/reference/setup-and-administration/sql-databases/group-keywords)**
- **[KPIs Attributes & Keywords Reference Table](/reference/setup-and-administration/sql-databases/kpi-keywords)**
- **[Charts Attributes & Keywords Reference Table](/reference/setup-and-administration/sql-databases/charts-keywords)**
- **[Tables Attributes & Keywords Reference Table](/reference/setup-and-administration/sql-databases/table-keywords)**

## Tutorial

Refer to the [SQL Tutorial](/setup-and-administration/automation/rcs-sql-tutorial) page for a full guide and demo on how to install and use the SQL Remote Context Server.