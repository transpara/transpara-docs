...
description: Learn how to configure Python interfaces for Visual KPI to retrieve and process data from any source, including examples of required methods for trends, historical values, and more.
tags: ['interfaces', 'data-integration', 'configuration', 'kpis', 'administrator']
---

<head>
  <title>Python Interface</title>
  <meta name="keywords" content="python interface, data integration, configuration, kpi interface, trend data, historical data, custom scripting, visual kpi"/>
</head>
...
<Callout type="note" title="Python.NET Limitations">
...
<Callout type="info" title="Additional Examples in Python Interface Folder">
