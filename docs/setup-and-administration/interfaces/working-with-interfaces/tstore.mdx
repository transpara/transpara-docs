...
description: Learn how to install and configure the Transpara tStore interface, retrieve metrics and lookups, and use parameters like filters, aggregation functions, and buckets in Visual KPI.
tags: ['interfaces', 'data-integration', 'kpis', 'configuration', 'administrator']
---

<head>
  <title>Transpara tStore Interface</title>
  <meta name="keywords" content="tstore interface, data integration, kpi interface, configuration, metrics, lookups, aggregation, filters, visual kpi"/>
</head>
