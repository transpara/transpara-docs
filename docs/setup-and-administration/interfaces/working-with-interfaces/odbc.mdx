...
description: Learn how to configure an ODBC interface for integrating SQL databases with Visual KPI, including query creation, parameterization, trend and historical data, and aggregation settings.
tags: ['interfaces', 'sql', 'data-integration', 'configuration', 'kpis', 'parameterization', 'administrator']
---

<head>
  <title>ODBC Interface</title>
  <meta name="keywords" content="odbc interface, sql database, data integration, configuration, kpi interface, parameterization, trend data, historical data, aggregation, stored procedures"/>
</head>
