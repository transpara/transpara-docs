...
These fields can be [parameterized](/setup-and-administration/interfaces/parameterizing).
</Callout>
...
<Callout type="info" title="Parameterizing">
The **start** and **end** values can be [parameterized](/setup-and-administration/interfaces/parameterizing) using `STARTDATE` and `ENDDATE`.
</Callout>
...
<Callout type="info" title="Parameterizing">
The **date** value can be [parameterized](/setup-and-administration/interfaces/parameterizing) using `TIMESTAMP`.
</Callout>
