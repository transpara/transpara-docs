...
description: Learn how to configure a JSON interface for integrating RESTful APIs with Visual KPI, including security settings, data paths, and parameterization for trend and historical data.
tags: ['interfaces', 'data-integration', 'configuration', 'data-sources']
---

<head>
  <title>JSON Interface</title>
  <meta name="keywords" content="json interface, rest api, data integration, parameterization, configuration, historical data, trend data, kpi interface, visual kpi"/>
</head>
...
<Callout type="info" title="JSON Data URL Formation">
