...
description: Learn how to parameterize Visual KPI interfaces, including ODBC and JSON interfaces, to enable dynamic querying of data using placeholders and configurable parameters.
tags: ['parameterization', 'interfaces', 'configuration', 'data-integration', 'administrator']
---

<head>
  <title>Parameterizing Interfaces</title>
  <meta name="keywords" content="parameterization, interfaces, odbc interface, json interface, configuration, trend data, historical data, placeholders, dynamic querying"/>
</head>
...
<Callout type="info" title="Using Actual Value with Pipes in Visual KPI Designer">
...
<Callout type="info" title="Formatting Actual Value in Visual KPI Designer">
