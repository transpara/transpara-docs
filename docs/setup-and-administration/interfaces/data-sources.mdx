...
description: Explore the supported data sources for Visual KPI, including industrial historians, relational databases, web services, manually entered data, business applications, and IoT devices.
tags: ['data-sources', 'interfaces', 'data-integration', 'administrator']
---

<head>
  <title>Supported Data Sources</title>
  <meta name="keywords" content="data sources, interfaces, data integration, industrial historians, relational databases, web services, manual data, business applications, IoT, IIoT, sensors, visual kpi"/>
</head>
