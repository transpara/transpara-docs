...
description: Learn how to upgrade your Visual KPI system, including updating the Server Manager, Designer instances, and site configurations, with detailed steps and video guidance.
tags: ['upgrade', 'server-management', 'administrator', 'configuration']
---

<head>
  <title>System Upgrade</title>
  <meta name="keywords" content="system upgrade, visual kpi, server manager, administrator, site upgrade, configuration, software update, visual kpi designer"/>
</head>
...
<Callout type="info" title="Installing Visual KPI Server Manager">
For detailed instructions on downloading and installing the Visual KPI Server Manager, refer to the guide on [Installing Visual KPI Server and Server Manager](/setup-and-administration/installation/install-visual-kpi).
</Callout>
...
1. Launch the Visual KPI Server Manager.
  ...
  <Callout type="info" title="Sorting Sites for Upgrade Readiness">
...
4. Based on whether you are upgrading one site or many, the following step will differ:
  ...
  <Callout type="info" title="Managing Site Upgrades">
...
6. Before starting the upgrade, review the setup information and check the list of sites to be upgraded. Click **Next** to begin the process.
  ...
  <Callout type="warning" title="Cancelable Upgrade Process">
...
<Video src="https://www.youtube.com/embed/DU8Vxl_SDLc" width="100%" />