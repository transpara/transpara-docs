...
tags: ['installation', 'server-manager', 'administrator', 'setup', 'configuration', 'database', 'troubleshooting']
---

<head>
  <title>Install Visual KPI Server Manager</title>
  <meta name="keywords" content="installation, server manager, visual kpi, administrator, setup, configuration, database, troubleshooting, visual kpi instance, license key"/>
</head>

This guide outlines the steps to install and use Visual KPI Server Manager. After installing our system, you will be ready to create your [Interfaces](/setup-and-administration/interfaces) and take full advantage of Visual KPI.
...
If Visual KPI Server Manager fails to open, make sure your computer meets all [prerequisites](/setup-and-administration/installation/prepare-your-system).
</Callout>
...
8. Define your Database Server. It can be a remote or local server.
  ...
  <Callout type="note" title="Configuration Database">
...
<Callout type="warning" title="Troubleshooting Visual KPI Issues">
If your instance of Visual KPI doesn't open or isn't working as expected, review the instructions on [Preparing your system](/setup-and-administration/installation/prepare-your-system), [Installing a Virtual Machine](/setup-and-administration/installation/hyper-v) (if you used a Virtual Machine), and this guide to see if you missed something.
</Callout>
