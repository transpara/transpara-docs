...
description: Learn how Visual KPI ensures data security by leveraging your organization's existing security model, including encryption, authentication, and rights assignment.
tags: ['security', 'object-level-security', 'administrator']
---

<head>
  <title>Security</title>
  <meta name="keywords" content="security, encryption, authentication, authorization, Active Directory, rights assignment, object-level security, Visual KPI, IIS, security inheritance"/>
</head>
