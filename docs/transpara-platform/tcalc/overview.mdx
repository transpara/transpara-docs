...
slug: /transpara-platform/tcalc/overview
---
...
Learn more about [tModel](/transpara-platform/getting-started/tmodel/), the powerful graph database that organizes and contextualizes your diverse data sources, or return to the [Core Modules](/transpara-platform/getting-started/core-modules/) overview.