...
Learn more about [tModel](/transpara-platform/core-modules/core-modules/tmodel/), the powerful graph database that organizes and contextualizes your diverse data sources, or return to the [Core Modules](/transpara-platform/core-modules/core-modules/) overview.