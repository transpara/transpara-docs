...
Learn about how [Deployment](/transpara-platform/deployment) works in this new system, offering unparalleled flexibility and speed for your operational intelligence, or return to the [Core Modules](/transpara-platform/core-modules/core-modules-page) overview.