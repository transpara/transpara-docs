...
> *Figure: Example tView dashboard displaying KPIs, alerts, and trend charts*  
> *(Insert screenshot or mockup from the April 2025 deck showing tView in use on desktop and mobile)*
