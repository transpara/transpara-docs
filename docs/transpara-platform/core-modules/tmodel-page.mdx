...
## What's next?
 ...
 Learn how to configure the system using [tStudio](/transpara-platform/core-modules/tstudio-page), or return to the [Core Modules](/transpara-platform/core-modules/core-modules-page) overview.