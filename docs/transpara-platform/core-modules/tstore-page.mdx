...
Learn how real-time logic is applied using [tCalc](/transpara-platform/core-modules/tcalc-page), or go back to the [Core Modules](/transpara-platform/core-modules) page.
