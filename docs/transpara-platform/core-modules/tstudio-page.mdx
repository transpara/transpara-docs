...
Learn how dashboards are used and shared with [tView](/transpara-platform/core-modules/core-modules/tview/), or return to the [Core Modules](/transpara-platform/core-modules/core-modules/) overview.
