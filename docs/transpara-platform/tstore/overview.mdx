...
Learn how real-time logic is applied using [tCalc](/transpara-platform/tcalc/overview/), or go back to the [Core Modules](/transpara-platform/getting-started/core-modules/) page.