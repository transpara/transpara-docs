...
Learn more about the system's [Architecture](/transpara-platform/architecture) or explore the [Core Modules](/transpara-platform/core-modules/core-modules-page).
