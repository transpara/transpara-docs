...
Learn more about the [System Requirements](/transpara-platform/system-requirements/) needed to power this advanced operational intelligence platform, or return to the [Overview](/transpara-platform/overview) page.
