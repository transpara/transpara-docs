...
Learn how dashboards are used and shared with [tView](/transpara-platform/tview/overview/), or return to the [Core Modules](/transpara-platform/getting-started/core-modules/) overview.
