...
slug: /transpara-platform/getting-started/core-modules
---
...
Learn more about [tStore](/transpara-platform/tstore/overview/) and how it provides high-scale, cost-effective data storage for your operational history and analytics.