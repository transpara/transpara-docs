...
slug: /transpara-platform/getting-started/tmodel
---
...
## What's next?
 ...
 Learn how to configure the system using [tStudio](/transpara-platform/tstudio/overview/), or return to the [Core Modules](/transpara-platform/getting-started/core-modules/) overview.