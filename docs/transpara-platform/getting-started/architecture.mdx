...
slug: /transpara-platform/getting-started/architecture
---
...
Explore how each component works in detail on the [Core Modules](/transpara-platform/getting-started/core-modules/) page.