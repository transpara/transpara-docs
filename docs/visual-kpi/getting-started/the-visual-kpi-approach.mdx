...
slug: /visual-kpi/getting-started/the-visual-kpi-approach
...
To learn more about where Visual KPI software lives and the security solutions it uses to protect your data, we recommend you access the [How Visual KPI works](/visual-kpi/getting-started/how-visual-kpi-works).
