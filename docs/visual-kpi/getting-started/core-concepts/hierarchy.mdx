...
slug: /visual-kpi/getting-started/core-concepts/hierarchy
...
<Image 
  src="media/getting-started/visual-kpi/getting-started/core-concepts/hierarchy/hierarchy-groups.png" 
/>
...
<Image 
  src="media/getting-started/visual-kpi/getting-started/core-concepts/hierarchy/hierarchy.gif" 
/>

## What's Next?

For more details on using the hierarchy and understanding its structure, you can access the [End User](/visual-kpi/end-user/overview) guide.
