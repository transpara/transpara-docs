---
title: Access Levels
slug: /visual-kpi/getting-started/core-concepts/access-level
...
Now that you have covered all the core concepts of the Visual KPI, it's time to check the specific content for your role. If you aren't familiar with the documentation organization, access the [How to Use the Documentation](/visual-kpi/getting-started/how-to-use-the-documentation) guide. Otherwise, you can see the specific section for each use type:

<CardList cols={3}>
  <Card 
    title="Setup and Administration"
    link ="/visual-kpi/setup-and-administration/overview"
  />

  <Card 
    title="Visual KPI Design" 
    link="/visual-kpi/visual-kpi-designer/overview"
  />
  <Card 
    title="End User" 
    link="/visual-kpi/end-user/overview"
  />
</CardList>