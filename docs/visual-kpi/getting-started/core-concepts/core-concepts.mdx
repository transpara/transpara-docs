---
title: Core concepts
slug: /visual-kpi/getting-started/core-concepts/core-concepts
...
<CardList cols={2}>
  <Card 
    ...
    link="/visual-kpi/getting-started/core-concepts/kpi"
  />
  <Card 
    ...
    link="/visual-kpi/getting-started/core-concepts/hierarchy"
  />
  <Card 
    ...
    link="/visual-kpi/getting-started/core-concepts/design"
  />
  <Card 
    title="Data Sources"
    ...
    link="/visual-kpi/getting-started/core-concepts/data-sources"
  />
  <Card 
    title="Interfaces"
    ...
    link="/visual-kpi/getting-started/core-concepts/interfaces"
  />
  <Card 
    title="Access Levels"
    ...
    link="/visual-kpi/getting-started/core-concepts/access-level"
  />
</CardList>

## What's Next?

If you want to recap the basic concepts of the Visual KPI, you can read our topic [What's Visual KPI](/visual-kpi/getting-started/what-is-visual-kpi).
