---
title: Interfaces
slug: /visual-kpi/setup-and-administration/interfaces/interfaces
...
<CardList cols={3}>
  <Card 
    title="Core Concepts"
    link="/visual-kpi/setup-and-administration/interfaces/core-concepts"
  />

  <Card 
    title="Configuration" 
    link="/visual-kpi/setup-and-administration/interfaces/configuring-interfaces"
  />

  <Card 
    title="Available Interfaces" 
    link="/visual-kpi/setup-and-administration/interfaces/available-interfaces"
  />

  <Card 
    title="Supported Data Sources" 
    link="/visual-kpi/setup-and-administration/interfaces/data-sources"
  />

  <Card 
    title="Working with Interfaces" 
    link="/visual-kpi/setup-and-administration/interfaces/working-with-interfaces"
  />
</CardList>
