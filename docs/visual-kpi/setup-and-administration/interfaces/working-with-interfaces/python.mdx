...
slug: /visual-kpi/setup-and-administration/interfaces/working-with-interfaces/python
description: ''
tags: ['documentation']
---
...
After installing a new Python interface following these [instructions](/visual-kpi/setup-and-administration/interfaces/configuring-interfaces), you are ready to configure your interface by adding your python script inside the **Python Settings** section.
