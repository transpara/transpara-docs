...
slug: /visual-kpi/setup-and-administration/interfaces/working-with-interfaces/odbc
description: ''
tags: ['documentation']
---
...
If you haven't installed your ODBC interface, refer to the [Configuration page](/visual-kpi/setup-and-administration/interfaces/configuring-interfaces) to learn how to install it.
</Callout>
...
After installing a new ODBC interface following these [instructions](/visual-kpi/setup-and-administration/interfaces/configuring-interfaces), you are ready to configure your interface. As an exercise, below you find an example SQL table that this guide uses to create the needed queries:
...
Visual KPI gives you the power to parameterize most data allowing you to create one interface to query for different data. To learn more about it, refer to the [Parameterizing Interfaces](/visual-kpi/setup-and-administration/interfaces/working-with-interfaces/parameterizing-interfaces) page.
</Callout>
...
In the query above, `STARTDATE` and `ENDDATE` are [parameters](/visual-kpi/setup-and-administration/interfaces/working-with-interfaces/parameterizing-interfaces) that will be replaced with actual timestamps when configuring in Visual KPI Designer to create a time range for the trend data.
...
Where `TIMESTAMP` is a [parameter](/visual-kpi/setup-and-administration/interfaces/working-with-interfaces/parameterizing-interfaces) that will be replaced with an actual timestamp when configuring in Visual KPI Designer to use this query.
...
<Image src="media/visual-kpi/setup-and-administration/interfaces/working-with-interfaces/odbc/aggregation-odbc.png" alt="Aggregation ODBC"/>
