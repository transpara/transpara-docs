...
slug: /visual-kpi/setup-and-administration/interfaces/working-with-interfaces/json
description: ''
tags: ['documentation']
---
...
After installing a new JSON interface following these [instructions](/visual-kpi/setup-and-administration/interfaces/configuring-interfaces), you are ready to configure your interface.
...
To use `CPU` as the **Value field**, and `timestamp` as the **Timestamp field**, you need to use [dot notation](https://developer.mozilla.org/en-US/Web/JavaScript/visual-kpi/reference/Operators/Property_accessors#dot_notation) to reach the required data:
...
These fields can be [parameterized](/visual-kpi/setup-and-administration/interfaces/working-with-interfaces/parameterizing-interfaces).
</Callout>
...
<Callout type="info" title="Parameterizing">
The **start** and **end** values can be [parameterized](/visual-kpi/setup-and-administration/interfaces/working-with-interfaces/parameterizing-interfaces) using `STARTDATE` and `ENDDATE`.
</Callout>
...
<Callout type="info" title="Parameterizing">
The **date** value can be [parameterized](/visual-kpi/setup-and-administration/interfaces/working-with-interfaces/parameterizing-interfaces) using `TIMESTAMP`.
</Callout>
