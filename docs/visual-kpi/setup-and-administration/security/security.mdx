---
title: Security
slug: /visual-kpi/setup-and-administration/security/security
description: 'Presents the security tools the user has access to in Visual KPI.'
tags: ['documentation']
---

Visual KPI is as secure as your organization's security. We don't require you to implement our security system, but rather, [we inherit your security system](/visual-kpi/setup-and-administration/security/security-inheritance).
...
Setting up security and encryption in Visual KPI is straightforward when you use Visual KPI Server Manager integrated with IIS Manager. Learn more about how Visual KPI security works with the [Security Inheritance](/visual-kpi/setup-and-administration/security/security-inheritance) guide or [Enable Security](/visual-kpi/setup-and-administration/security/enable-security) with our step-by-step guide.