...
slug: /visual-kpi/setup-and-administration/security/enable-security
description: ''
tags: ['documentation']
---
...
<Image 
  src="media/visual-kpi/setup-and-administration/security/enable-security/decouple-1.png"
  alt="Components"
/>
...
<Image 
  src="media/visual-kpi/setup-and-administration/security/enable-security/decouple-2.png"
...
<Image 
  src="media/visual-kpi/setup-and-administration/security/enable-security/decouple-3.png"
/>

4. In **Advanced Security Settings**, on the **Permissions** tab, click **Disable inheritance**.

<Image 
  src="media/visual-kpi/setup-and-administration/security/enable-security/decouple-4.png"
...
<Image 
  src="media/visual-kpi/setup-and-administration/security/enable-security/decouple-5.png"
...
<Image 
  src="media/visual-kpi/setup-and-administration/security/enable-security/iis-manager-1.png"
  alt="IIS Manager"
/>
...
<Image 
  src="media/visual-kpi/setup-and-administration/security/enable-security/iis-manager-2.png"
  alt="Authentication"
/>
...
<Image 
  src="media/visual-kpi/setup-and-administration/security/enable-security/iis-manager-3.png"
/>
...
<Image 
  src="media/visual-kpi/setup-and-administration/security/enable-security/security-groups-1.png"
...
<Image 
  src="media/visual-kpi/setup-and-administration/security/enable-security/security-groups-2.png"
...
<Image 
  src="media/visual-kpi/setup-and-administration/security/enable-security/security-groups-3.png"
  alt="New Group"
/>
...
<Image 
  src="media/visual-kpi/setup-and-administration/security/enable-security/security-groups-4.png"
  alt="Add Members"
/>
...
<Image 
  src="media/visual-kpi/setup-and-administration/security/enable-security/security-groups-5.png"
  alt="Check Name"
/>
...
<Image 
  src="media/visual-kpi/setup-and-administration/security/enable-security/security-groups-6.png"
...
<Image 
  src="media/visual-kpi/setup-and-administration/security/enable-security/security-groups-7.png"
  alt="Add Permissions"
/>
...
<Image 
  src="media/visual-kpi/setup-and-administration/security/enable-security/security-groups-8.png"
  alt="Locations"
/>
...
<Image 
  src="media/visual-kpi/setup-and-administration/security/enable-security/security-groups-9.png"
