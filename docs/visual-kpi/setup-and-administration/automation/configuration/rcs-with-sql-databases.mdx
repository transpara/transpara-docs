...
slug: /visual-kpi/setup-and-administration/automation/configuration/rcs-with-sql-databases
...
- **[Groups Attributes & Keywords Reference Table](/visual-kpi/reference/setup-and-administration/sql-database-keywords/group)**
- **[KPIs Attributes & Keywords Reference Table](/visual-kpi/reference/setup-and-administration/sql-database-keywords/kpi)**
- **[Charts Attributes & Keywords Reference Table](/visual-kpi/reference/setup-and-administration/sql-database-keywords/charts)**
- **[Tables Attributes & Keywords Reference Table](/visual-kpi/reference/setup-and-administration/sql-database-keywords/table)**

## Tutorial

Refer to the [SQL Tutorial](/visual-kpi/setup-and-administration/automation/configuration/sql-tutorial) page for a full guide and demo on how to install and use the SQL Remote Context Server.