---
title: SQL Tutorial
slug: /visual-kpi/setup-and-administration/automation/configuration/sql-tutorial
...
- An installed version of [Visual KPI Server Manager](/visual-kpi/setup-and-administration/installation/install-visual-kpi-server-manager) on a machine with all the [prerequisites and required permissions](/visual-kpi/setup-and-administration/installation/prepare-your-system).
- An installed version of [Visual KPI Designer](/visual-kpi/visual-kpi-designer/installation-and-setup/overview).
...
To install a new instance, refer to the [Install Visual KPI](/visual-kpi/setup-and-administration/installation/install-visual-kpi-server-manager#installing-a-visual-kpi-instance) guide.
...
<Image
  src="media/visual-kpi/setup-and-administration/automation/sql-tutorial/sql-remote-context-server-1.png"
/>
...
<Image
  src="media/visual-kpi/setup-and-administration/automation/sql-tutorial/sql-remote-context-server-2.png"
/>
...
<Image
  src="media/visual-kpi/setup-and-administration/automation/sql-tutorial/sql-remote-context-server-3.png"
  size = "80%"
/>
...
<Image
  src="media/visual-kpi/setup-and-administration/automation/sql-tutorial/sql-remote-context-server-4.png"
  size = "80%"
/>
...
<Image
  src="media/visual-kpi/setup-and-administration/automation/sql-tutorial/sql-remote-context-server-5.png"
  size = "80%"
/>
...
To learn how to install a new ODBC Interface, refer to the [Interfaces guide](/visual-kpi/setup-and-administration/interfaces/configuring-interfaces) of this documentation.
...
To learn how to verify that everything is set up correctly, refer to the [Interfaces guide](/visual-kpi/setup-and-administration/interfaces/configuring-interfaces#verifying-an-interface-connection) of this documentation.
</Callout>
...
<Image
  src="media/visual-kpi/setup-and-administration/automation/sql-tutorial/sql-remote-context-server-6.png"
/>
...
Install a new Remote Context Server (RCS). To learn how, refer to the [Installation guide](/visual-kpi/setup-and-administration/automation/configuration/rcs-configuration#installing-visual-kpi-rcs).
...
<Image
  src="media/visual-kpi/setup-and-administration/automation/sql-tutorial/sql-remote-context-server-7.png"
/>

Since location data was also added, you will also be able to view Geo Maps.

<Image
  src="media/visual-kpi/setup-and-administration/automation/sql-tutorial/sql-remote-context-server-8.png"
/>
...
<Image
  src="media/visual-kpi/setup-and-administration/automation/sql-tutorial/sql-remote-context-server-9.png"
/>
...
<Image
  src="media/visual-kpi/setup-and-administration/automation/sql-tutorial/sql-remote-context-server-10.png"
/>
...
<Image
  src="media/visual-kpi/setup-and-administration/automation/sql-tutorial/sql-remote-context-server-11.png"
/>
...
<Tabs>
  <TabItem value="Trends" label="Trends" default>
    <Image
      src="media/visual-kpi/setup-and-administration/automation/sql-tutorial/sql-remote-context-server-12.png"
    />
  </TabItem>
  <TabItem value="Bar Charts" label="Bar Charts">
    <Image
      src="media/visual-kpi/setup-and-administration/automation/sql-tutorial/sql-remote-context-server-13.png"
    />
  </TabItem>
</Tabs>
...
<Image
  src="media/visual-kpi/setup-and-administration/automation/sql-tutorial/sql-remote-context-server-14.png"
/>
...
<Image
  src="media/visual-kpi/setup-and-administration/automation/sql-tutorial/sql-remote-context-server-15.png"
/>