...
slug: /visual-kpi/setup-and-administration/installation/prepare-your-system
...
If you don't have a Windows Server and still want to experiment with Visual KPI Server Manager, you can [install a Virtual Machine using Hyper-V](/visual-kpi/setup-and-administration/installation/install-a-vm-with-hyper-v).
</Callout>
...
<Image 
  src="media/visual-kpi/setup-and-administration/installation/prepare-your-system/iis-gif.gif" 
  alt="iss setup"
/>
...
<Image 
  src="media/visual-kpi/setup-and-administration/installation/prepare-your-system/server-manager-gif.gif" 
...
<Image 
  src="media/visual-kpi/setup-and-administration/installation/prepare-your-system/sql-manager-gif.gif" 
...
After performing all steps above, your system is ready to have Visual KPI Server Manager installed. To learn how to install our system, refer to the [Install Visual KPI](/visual-kpi/setup-and-administration/installation/install-visual-kpi-server-manager) page.
