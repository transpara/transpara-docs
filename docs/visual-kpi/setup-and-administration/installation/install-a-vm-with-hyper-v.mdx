...
slug: /visual-kpi/setup-and-administration/installation/install-a-vm-with-hyper-v
description: ''
...
Once you finish the initial configurations, you'll have a new Windows environment to work on. Now you can go back to [Preparing your system for Visual KPI Server Manager](/visual-kpi/setup-and-administration/installation/prepare-your-system). 