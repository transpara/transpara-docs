...
slug: /visual-kpi/setup-and-administration/installation/install-visual-kpi-server-manager
description: 'Presents the steps the administrator must follow to install Visual KPI into their server or cloud.'
tags: ['documentation']
---

This guide outlines the steps to install and use Visual KPI Server Manager. After installing our system, you will be ready to create your [Interfaces](/visual-kpi/setup-and-administration/interfaces/interfaces) and take full advantage of Visual KPI.
...
If Visual KPI Server Manager fails to open, make sure your computer meets all [prerequisites](/visual-kpi/setup-and-administration/installation/prepare-your-system).
</Callout>

As Visual KPI Server Manager opens, it will look like the following picture:

<Image 
  src="media/visual-kpi/setup-and-administration/installation/install-visual-kpi-server-manager/server-manager-home.png" 
...
<Video src="media/visual-kpi/setup-and-administration/installation/install-visual-kpi-server-manager/instance-install.mp4"/>
...
<Image 
  src="media/visual-kpi/setup-and-administration/installation/install-visual-kpi-server-manager/website.png" 
  alt="website-example"
/>

<Callout type="note">
If your instance of Visual KPI doesn't open or isn't working as expected, review the instructions on [Preparing your system](/visual-kpi/setup-and-administration/installation/prepare-your-system), [Installing a Virtual Machine](/visual-kpi/setup-and-administration/installation/install-a-vm-with-hyper-v) (if you used a Virtual Machine), and this guide to see if you missed something.
</Callout>
...
<Video src="https://www.youtube.com/embed/qjLk-N7fkqU?start=643"/>