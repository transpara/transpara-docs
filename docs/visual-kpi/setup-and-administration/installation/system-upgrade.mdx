...
slug: /visual-kpi/setup-and-administration/installation/system-upgrade
...
<Callout type="info">
For detailed instructions on downloading and installing the Visual KPI Server Manager, refer to the guide on [Installing Visual KPI Server and Server Manager](/visual-kpi/setup-and-administration/installation/install-visual-kpi-server-manager).
</Callout>
...
<Video src="https://www.youtube.com/embed/DU8Vxl_SDLc" />