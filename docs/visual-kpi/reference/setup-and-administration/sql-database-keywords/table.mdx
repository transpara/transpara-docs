...
slug: /visual-kpi/reference/setup-and-administration/sql-database-keywords/table
description: ''
tags: ['documentation']
---

import table from '@site/data/references/visual-kpi/setup-and-administration/sql-database-keywords/table.json';
