...
title: Links
slug: /visual-kpi/reference/visual-kpi-designer/data-limits/links
description: ''
tags: ['documentation']
---

import table from '@site/data/references/visual-kpi/visual-kpi-designer/data-limits/Links.json';
