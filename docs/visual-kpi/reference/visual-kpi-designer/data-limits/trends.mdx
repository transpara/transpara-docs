...
title: Trends
slug: /visual-kpi/reference/visual-kpi-designer/data-limits/trends
description: ''
tags: ['documentation']
---

import table from '@site/data/references/visual-kpi/visual-kpi-designer/data-limits/Trends.json';
