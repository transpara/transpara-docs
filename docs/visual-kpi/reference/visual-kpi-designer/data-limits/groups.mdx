...
title: Groups
slug: /visual-kpi/reference/visual-kpi-designer/data-limits/groups
description: ''
tags: ['documentation']
---

import table from '@site/data/references/visual-kpi/visual-kpi-designer/data-limits/Groups.json';
