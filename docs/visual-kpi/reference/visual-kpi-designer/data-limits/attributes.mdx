...
title: Attributes
slug: /visual-kpi/reference/visual-kpi-designer/data-limits/attributes
description: ''
tags: ['documentation']
---

import table from '@site/data/references/visual-kpi/visual-kpi-designer/data-limits/Attributes.json';
