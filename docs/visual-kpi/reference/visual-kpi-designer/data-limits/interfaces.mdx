...
title: Interfaces
slug: /visual-kpi/reference/visual-kpi-designer/data-limits/interfaces
description: ''
tags: ['documentation']
---

import table from '@site/data/references/visual-kpi/visual-kpi-designer/data-limits/Interfaces.json';
