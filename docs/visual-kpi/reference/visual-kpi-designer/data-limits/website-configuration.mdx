...
slug: /visual-kpi/reference/visual-kpi-designer/data-limits/website-configuration
description: ''
tags: ['documentation']
---

import table from '@site/data/references/visual-kpi/visual-kpi-designer/data-limits/WebsiteConfiguration.json';
