...
title: KPIs
slug: /visual-kpi/reference/visual-kpi-designer/data-limits/kpis
description: ''
tags: ['documentation']
---

import table from '@site/data/references/visual-kpi/visual-kpi-designer/data-limits/KPIs.json';
