...
title: Trend Ranges
slug: /visual-kpi/reference/visual-kpi-designer/data-limits/trend-ranges
description: ''
tags: ['documentation']
---

import table from '@site/data/references/visual-kpi/visual-kpi-designer/data-limits/TrendRanges.json';
