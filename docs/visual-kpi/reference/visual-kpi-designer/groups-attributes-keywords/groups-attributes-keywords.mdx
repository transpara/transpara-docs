...
slug: /visual-kpi/reference/visual-kpi-designer/groups-attributes-keywords/groups-attributes-keywords
description: ''
tags: ['documentation']
---

import table from '@site/data/references/visual-kpi/visual-kpi-designer/groups-attributes-keywords/VisualKPIDesignerAFSQLAndInmationAttributes.json';
