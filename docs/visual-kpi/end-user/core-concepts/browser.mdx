---
title: Browser
slug: /visual-kpi/end-user/core-concepts/browser
...
<Image src="media/visual-kpi/end-user/core-concepts/browser/group-illustration.png"/>
...
<Image src="media/visual-kpi/end-user/core-concepts/browser/kpi-illustration.png"/>

### Charts

Select the Charts icon to visualize your data and open any Chart in the list to see its details in the data panel.

<Image src="media/visual-kpi/end-user/core-concepts/browser/charts-illustration.png"/>
...
<Image src="media/visual-kpi/end-user/core-concepts/browser/tables-illustration.png"/>
...
<Image src="media/visual-kpi/end-user/core-concepts/browser/quickstart.png"/>
