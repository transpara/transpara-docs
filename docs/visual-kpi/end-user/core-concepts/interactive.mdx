---
title: Interactive
slug: /visual-kpi/end-user/core-concepts/interactive
...
After completing the Core Concepts content, check the [Basic Navigation](/visual-kpi/end-user/overview) features Visual KPI offers for end users.