---
title: End Users
slug: /visual-kpi/end-user/overview
...
On the [Core Concepts](/visual-kpi/end-user/core-concepts/core-concepts) pages, you'll find the main ideas surrounding the Visual KPI software, such as its responsiveness and interactive platform, real-time data processing, and a wide variety of KPI visualizations.

## Basic Navigation

Further, in [Basic Navigation](/visual-kpi/end-user/overview), you'll explore the main functionalities of Visual KPI as we present the basics of objects like Profiles, Dashboards, and Groups. You'll learn how to customize your view and read your KPIs at a glance, organize and navigate through your KPIs using groups, and set up and manage alerts to stay informed about critical changes in your KPIs.

## Features

Then, in [Features](/visual-kpi/end-user/features/features), we'll dive deeply into advanced ways of using Visual KPI tools. Learn how to do trend analysis within Visual KPI and customize your view to suit your specific needs by exploring the various visualization options available in our software.
