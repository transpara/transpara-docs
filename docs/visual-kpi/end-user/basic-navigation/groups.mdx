...
slug: /visual-kpi/end-user/basic-navigation/groups
...
<Image src="media/visual-kpi/end-user/basic-navigation/groups/legend.gif"/>
...
<Image src="media/visual-kpi/end-user/basic-navigation/groups/drill-down.gif"/>
...
<Image src="media/visual-kpi/end-user/basic-navigation/groups/groups-without-table.gif"/>
...
<Image src="media/visual-kpi/end-user/basic-navigation/groups/breadcrumbs.png"/>
...
5. **View as KPI Map** (<SvgFont icon="5"/>): This option enables you to view a graphical heat map of all the KPIs in the level you are currently on. For more information, see [Visualization](/visual-kpi/end-user/basic-navigation/visualization#view-as-kpi-map).
6. **View as Group Map** (<SvgFont icon="141"/>): This view is similar to the **View as KPI Map** but is more advanced and gives each Group its status. For more information, see [Visualization](/visual-kpi/end-user/basic-navigation/visualization#view-as-group-map).
7. **View as Group Map Table** (<SvgFont icon="21"/>): This View shows groups as titles in a table. For more information, see [Visualization](/visual-kpi/end-user/basic-navigation/visualization#view-as-group-map-table).
8. **View as Geo Map** (<SvgFont icon="264"/>): This option combines the latitude and longitude of your assets and Google Maps to create an interactive visualization right inside the Visual KPI. For more information, see [Visualization](/visual-kpi/end-user/basic-navigation/visualization#view-as-geo-map).
...
<Image src="media/visual-kpi/end-user/basic-navigation/groups/group-on-dashboard-visualization.png"/>
...
Want to know more about Group visualization? Access the [Visualization](/visual-kpi/end-user/features/visualizations/visualizations) page to learn the basics of the different visualizations for your Groups and KPIs.