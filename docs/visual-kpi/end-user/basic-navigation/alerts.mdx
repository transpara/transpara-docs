---
title: Alerts
slug: /visual-kpi/end-user/basic-navigation/alerts
...
<Image 
  src="media/visual-kpi/end-user/basic-navigation/alerts/notification.png"
  size="80%"
/>
...
<Image src="media/visual-kpi/end-user/basic-navigation/alerts/trend-alerts.png"/>
...
Learn how to [change between themes](/visual-kpi/end-user/basic-navigation/dark-light-theme) in Visual KPI.