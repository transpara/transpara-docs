---
title: Profiles
slug: /visual-kpi/end-user/basic-navigation/profiles
...
<Image src="media/visual-kpi/end-user/basic-navigation/profiles/customizable-items.png"/>
...
<Image src="media/visual-kpi/end-user/basic-navigation/profiles/dropdown-menu.png"/>
...
<Image src="media/visual-kpi/end-user/basic-navigation/profiles/create-profile.gif"/>
...
<Image src="media/visual-kpi/end-user/basic-navigation/profiles/change-profile.gif"/>
