---
title: Time
slug: /visual-kpi/end-user/basic-navigation/time
...
<Image src="media/visual-kpi/end-user/basic-navigation/time/timestamp.png"/>
...
<Image src="media/visual-kpi/end-user/basic-navigation/time/time-offset.gif"/>
