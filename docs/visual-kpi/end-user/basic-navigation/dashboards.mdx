---
title: Dashboards
slug: /visual-kpi/end-user/basic-navigation/dashboards
...
<Image src="media/visual-kpi/end-user/basic-navigation/dashboards/dropdown-menu.png"/>
...
<Image src="media/visual-kpi/end-user/basic-navigation/dashboards/create-dashboard.gif"/>
...
<Image src="media/visual-kpi/end-user/basic-navigation/dashboards/menu-options.png"/>
...
<Image src="media/visual-kpi/end-user/basic-navigation/dashboards/resize-move-kpi.gif"/>
...
<Image src="media/visual-kpi/end-user/basic-navigation/dashboards/kpi-visualization.png"/>
...
<Image src="media/visual-kpi/end-user/basic-navigation/dashboards/add-to-dashboard.gif"/>
...
<Image src="media/visual-kpi/end-user/basic-navigation/dashboards/dashboard-time-range.gif"/>
