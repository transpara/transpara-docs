---
title: Analytics
slug: /visual-kpi/end-user/basic-navigation/analytics
...
<Image src="media/visual-kpi/end-user/basic-navigation/analytics/trendview.gif"/>
...
<Image src="media/visual-kpi/end-user/basic-navigation/analytics/option-menu.png"/>
...
<Image src="media/visual-kpi/end-user/basic-navigation/analytics/trend-example.gif"/>
