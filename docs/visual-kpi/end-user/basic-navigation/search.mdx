---
title: Search
slug: /visual-kpi/end-user/basic-navigation/search
...
<Image src="media/visual-kpi/end-user/basic-navigation/search/search-tool.png"/>
...
<Image src="media/visual-kpi/end-user/basic-navigation/search/search-in-object.gif"/>
...
<Image src="media/visual-kpi/end-user/basic-navigation/search/search.gif"/>
...
Check the [Analytics](/visual-kpi/end-user/basic-navigation/analytics) Visual KPI provides.