---
title: Visualization
slug: /visual-kpi/end-user/basic-navigation/visualization
...
The Group Roll-Up is the list view, which is the default view in [Groups](/visual-kpi/end-user/basic-navigation/groups). You can always come back to this view by clicking the **List View** icon (<SvgFont icon="206"/>).

<Image src="media/visual-kpi/end-user/basic-navigation/visualization/groups-rollup.png"/>
...
<Image src="media/visual-kpi/end-user/basic-navigation/visualization/drill-down.gif"/>
...
1. [**Filter**](/visual-kpi/end-user/basic-navigation/visualization/#filters) (<SvgFont icon="184"/>)
2. [**Only show descendant/child groups**](/visual-kpi/end-user/basic-navigation/visualization/#only-show-descendantchild-groups) (<SvgFont icon="207"/> / <SvgFont icon="208"/>)
3. **Add Group to Dashboard** (<SvgFont icon="115"/>)
4. [**View as List**](/visual-kpi/end-user/basic-navigation/visualization/#group-roll-upslist-view) (<SvgFont icon="206"/>)
5. [**View as KPI Map**](/visual-kpi/end-user/basic-navigation/visualization/#view-as-kpi-map) (<SvgFont icon="5"/>)
6. [**View as Group Map**](/visual-kpi/end-user/basic-navigation/visualization/#view-as-group-map) (<SvgFont icon="141"/>)
7. [**View as Group Map Table**](/visual-kpi/end-user/basic-navigation/visualization/#view-as-group-map-table) (<SvgFont icon="21"/>)
8. [**View as Geo Map**](/visual-kpi/end-user/basic-navigation/visualization/#view-as-geo-map) (<SvgFont icon="264"/>)

<Image src="media/visual-kpi/end-user/basic-navigation/visualization/visualization-options.png"/>
...
- [Status Filter](/visual-kpi/end-user/basic-navigation/visualization/#status-filter)
- [Near Me Filter](/visual-kpi/end-user/basic-navigation/visualization/#near-me-filter)
...
<Image src="media/visual-kpi/end-user/basic-navigation/visualization/filter.gif"/>
...
<Image src="media/visual-kpi/end-user/basic-navigation/visualization/near-me-filter.png"/>
...
<Image src="media/visual-kpi/end-user/basic-navigation/visualization/childgroups.gif"/>
...
<Image src="media/visual-kpi/end-user/basic-navigation/visualization/kpimap.png"/>

#### Add Block to Dashboard

When visualizing KPIs as blocks, you can select one or more and add them directly to the Dashboard. To do that, select the desired KPIs, which will show at the top of the page. Once all the KPIs you wish to add are selected, click on **Add to Dashboard**. After they are in your Dashbaord, you can [customize the Dashboard](/visual-kpi/end-user/basic-navigation/dashboards#customize-a-dashboard) as you wish.

<Image src="media/visual-kpi/end-user/basic-navigation/visualization/block-dashboard-widget.gif"/>

### View as Group Map

The Group Map (<SvgFont icon="141"/>) view is similar to the [View as KPI Map](/visual-kpi/end-user/basic-navigation/visualization/#view-as-kpi-map) but is more advanced and gives each Group its status. Based on a configurable time limit, they show the KPIs within a group and highlight the worst-performing and recently changed KPIs. In the Visual KPI Group Map, you can quickly see if any KPIs are in alert condition.
...
<Image src="media/visual-kpi/end-user/basic-navigation/visualization/groupmap.gif"/>
...
The Group Map Table (<SvgFont icon="21"/>) view is similar to the [Group Map](/visual-kpi/end-user/basic-navigation/visualization/#view-as-group-map) view but has a different layout. It shows groups as titles in a table. As happens when using the [Group Map](/visual-kpi/end-user/basic-navigation/visualization/#view-as-group-map), you can select and click on any KPI in the Group Map Table to display details and other KPI options.

<Image src="media/visual-kpi/end-user/basic-navigation/visualization/group-map-table.gif"/>
...
In addition to the default Google Maps tools, you can click a set of values on the map to see details. If you are viewing a Geo Map based on groups, you may see a pie chart that sums up everything in that group. Clicking on the pie chart opens details for any groups displayed. You can even use your GPS location or IP address to [filter](/visual-kpi/end-user/basic-navigation/visualization/#near-me-filter) data based on its physical distance from you.

<Image src="media/visual-kpi/end-user/basic-navigation/visualization/geomap.gif"/>
...
Having trouble finding KPIs? Learn how to quickly find any information on Visual KPI by accessing the [Search](/visual-kpi/end-user/basic-navigation/search) content for Basic Navigation.