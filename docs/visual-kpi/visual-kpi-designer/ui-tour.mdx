---
title: UI Tour
slug: /visual-kpi/visual-kpi-designer/ui-tour
...
7. **Toggle basic and advanced modes** (<PngFont name='advancedmode28gray' />): Hides or shows advanced columns. When working in Basic Mode, you see fewer columns. For more details, go to the [Additional Features guide](/visual-kpi/visual-kpi-designer/additional-features).
...
4. **Preview updates** (<PngFont name='preview28-2.fw' />): Shows a preview of the calculations of the selected objects. This can take a long time if you mark many items on the worksheet. For more details, go to the [Additional Features guide](/visual-kpi/visual-kpi-designer/additional-features).
...
After understanding more about the disposition of Visual KPI Designer parts, you can start configuring the basic information for your site by accessing [Basic Setup](/visual-kpi/visual-kpi-designer/installation-and-setup/basic-setup).