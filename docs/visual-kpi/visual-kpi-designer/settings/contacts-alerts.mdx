...
slug: /visual-kpi/visual-kpi-designer/settings/contacts-alerts
description: ''
tags: ['documentation']
---
...
If some of the available parameters are unclear, you can refer to the [Contacts](/visual-kpi/reference/visual-kpi-designer/site-settings/contacts) reference page.
...
1. Add a **Name** on the first blank row below the column headers.
2. Add a **Description** if appropriate.
3. Enter Alert Template configurations. See the [Alerts](/visual-kpi/reference/visual-kpi-designer/site-settings/alerts) reference page for a detailed description of each option available.
