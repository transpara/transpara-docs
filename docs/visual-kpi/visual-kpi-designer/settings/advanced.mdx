...
id: advanced
title: Advanced
slug: /visual-kpi/visual-kpi-designer/settings/advanced
description: ''
tags: ['documentation']
---
...
An Administrator must set up the interface before it appears in Visual KPI Designer. For more information on how to set up an interface, go to the [Admin guide for Interfaces Configuration](/visual-kpi/setup-and-administration/interfaces/configuring-interfaces).
</Callout>
