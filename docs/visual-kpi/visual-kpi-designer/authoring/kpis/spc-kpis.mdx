...
slug: /visual-kpi/visual-kpi-designer/authoring/kpis/spc-kpis
description: ''
tags: ['documentation']
---
...
Select a limit as the state to display, or choose a [custom status](/visual-kpi/visual-kpi-designer/settings/features-config#kpi-status).
