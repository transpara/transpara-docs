...
id: charts
title: Charts
slug: /visual-kpi/visual-kpi-designer/authoring/charts/charts
description: ''
tags: ['documentation']
---
...
<Callout title="Working with Charts">
...
<CardList cols={4}>
  <Card 
    title="Bar Charts"
    link="/visual-kpi/visual-kpi-designer/authoring/charts/bar-chart"
  />
  <Card 
    title="Gantt Charts"
    link="/visual-kpi/visual-kpi-designer/authoring/charts/gantt-chart"
  />
  <Card 
    title="Pareto Charts"
    link="/visual-kpi/visual-kpi-designer/authoring/charts/pareto-chart"
  />
  <Card 
    title="Pie Charts"
    link="/visual-kpi/visual-kpi-designer/authoring/charts/pie-chart"
  />
  <Card 
    title="XY Plots"
    link="/visual-kpi/visual-kpi-designer/authoring/charts/xy-plots"
  />
  <Card 
    title="Query Based Charts"
    link="/visual-kpi/visual-kpi-designer/authoring/charts/query-based-chart"
  />
  <Card 
    title="Box Plots"
    link="/visual-kpi/visual-kpi-designer/authoring/charts/box-plots"
  />
</CardList>