---
title: Authoring
slug: /visual-kpi/visual-kpi-designer/authoring/overview
...
<CardList cols={3}>
  <Card 
    title="Groups"
    link="/visual-kpi/visual-kpi-designer/authoring/groups"
  />
  <Card 
    title="KPIs"
    link="/visual-kpi/visual-kpi-designer/authoring/kpis"
  />
  <Card 
    title="Charts"
    link="/visual-kpi/visual-kpi-designer/authoring/charts"
  />
  <Card 
    title="Tables"
    link="/visual-kpi/visual-kpi-designer/authoring/tables"
  />
  <Card 
    title="Trends"
    link="/visual-kpi/visual-kpi-designer/authoring/trends"
  />
</CardList>
