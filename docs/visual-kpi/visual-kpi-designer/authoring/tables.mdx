...
id: tables
title: Tables
slug: /visual-kpi/visual-kpi-designer/authoring/tables
description: ''
tags: ['documentation']
---
...
See a full list of all possible Table attributes in the [Tables Attributes & Keyword Reference](/visual-kpi/reference/visual-kpi-designer/attributes-and-keywords/tables).
...
You can find more details about this feature in the [Info Column section](/visual-kpi/visual-kpi-designer/authoring/overview#info-column).