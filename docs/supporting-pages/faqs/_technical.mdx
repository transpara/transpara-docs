...
<AccordionGroup>
  ...
  <Accordion title="Can I share, open or link to a specific dashboard, regardless of what profile is currently selected?">
    ...
    To learn more about each of these options to Customize Your Visual KPI Dashboard, refer to the [Dashboard](/visual-kpi/end-user/basic-navigation/dashboards) page of the Basic Navigation guide.
  </Accordion>
  ...
  <Accordion title="How to share or link to a specific Dashboard?">
    ...
    - [Add Visual KPI Nav Bar Links](/visual-kpi/visual-kpi-designer/installation-and-setup/connecting)
    - [Pin Other Dashboard Links to the Bookmark Bar](/visual-kpi/end-user/features/profiles)
    - [Dashboards using a Link Widget](/visual-kpi/end-user/basic-navigation/dashboards#customize-a-dashboard)
  </Accordion>
