...
<SearchWrapper>
  <AccordionGroup>
    <Accordion title="Is it possible to add a logo, image, or text box label to the Dashboard?">
      You have the flexibility to add a wide range of items to your Dashboard, such as KPIs, charts, trends, [embedded content](/visual-kpi/end-user/features/visualizations/charts) from external sources, groups/hierarchies, and more. Additionally, you can personalize your Dashboard by including [custom logos and other images](/visual-kpi/end-user/features/dashboards). You can [add labels, static text, and dynamic objects](/visual-kpi/end-user/features/dashboards) from data sources using [Visual KPI Interfaces](/visual-kpi/setup-and-administration/interfaces/interfaces).
      ...
      - [Charts Visualization](/visual-kpi/end-user/features/visualizations/charts)
      - [Dashboard Features](/visual-kpi/end-user/features/dashboards)
      - [Visual KPI Interfaces](/visual-kpi/setup-and-administration/interfaces/interfaces)
    ...
    <Accordion title="Is Dashboard to Dashboard navigation possible?">
      ...
      Learn more about [Visual KPI Groups](/visual-kpi/end-user/features/groups).
    </Accordion>
