...
description: Detailed reference for website configuration data limits in Visual KPI Designer, including field types, restrictions, and configuration options.
tags: ['reference', 'designer', 'visual-kpi-designer']
---

<head>
  <title>Website Configuration</title>
  <meta name="keywords" content="Website Configuration, Data Limits, Visual KPI Designer, designer, Visual KPI, reference, field types, character limits"/>
</head>
