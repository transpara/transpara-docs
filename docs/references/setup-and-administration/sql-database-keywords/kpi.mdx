...
description: Reference guide for mapping KPI attributes and keywords from external data sources to Visual KPI, including AF, SQL, and inmation databases.
tags: ['reference', 'administrator', 'setup-and-administration']
---

<head>
  <title>KPIs Attributes</title>
  <meta name="keywords" content="KPIs Attributes, Visual KPI, SQL Databases, AF Databases, setup and administration, reference, administrator"/>
</head>
