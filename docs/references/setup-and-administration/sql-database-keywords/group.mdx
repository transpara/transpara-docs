...
description: Reference guide for mapping group attributes and keywords from external data sources to Visual KPI, including AF, SQL, and inmation databases.
tags: ['reference', 'administrator', 'setup-and-administration']
---

<head>
  <title>Groups Attributes</title>
  <meta name="keywords" content="Groups Attributes, Visual KPI, SQL Databases, AF Databases, setup and administration, reference, administrator"/>
</head>

import table from '@site/data/references/setup-and-administration/sql-database-keywords/group.json';
