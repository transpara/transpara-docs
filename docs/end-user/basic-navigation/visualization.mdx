...
To view more details of a specific KPI, you can click on it. Once selected, it will appear at the top of the screen, in the Scrachpad. When hovering over the KPIs in the Scrachpad, they will be highlighted. If you click on a KPI already in the Scrachpad, it will be removed from it.

#### Add Block to Dashboard

When visualizing KPIs as blocks, you can select one or more and add them directly to the Dashboard. To do that, select the desired KPIs, which will show at the top of the page, in the Scrachpad. Once all the KPIs you wish to add are selected, click on **Add to Dashboard**. After they are in your Dashbaord, you can [customize the Dashboard](/end-user/basic-navigation/dashboards#customize-a-dashboard) as you wish.
...
The Group Map options will only appear if the designer configures them to be available.
</Callout>
...
The Geo Map options will only appear if the designer configures them to be available.
</Callout>
