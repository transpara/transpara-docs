...
slug: groups
description: Learn how to organize, navigate, and manage groups in Visual KPI, including hierarchy structures, visualizations, and dashboard integration.
tags: ['basic-navigation', 'quick-start', 'end-user', 'groups', 'organization', 'data-management', 'visualizations']
---

<head>
  <title>Hierarchy/Groups</title>
  <meta name="keywords" content="Visual KPI, hierarchy, groups, end-user guide, group organization, data management, KPI hierarchy, group customization, breadcrumbs, group visualization, add groups to dashboard, roll-up visualization, KPI groups, navigation tips"/>
</head>
...
Hover your mouse over any status in the list to see details. As you move your mouse over the various colors representing status, you'll see a tooltip that tells you how many total KPIs are in the Group and how many are in that particular state. The colors and whether or not the condition is an alert status depends on your data, targets, and limits. These formulas are all set up within the Visual KPI Designer.
...
5. **View as KPI Map** (<SvgFont icon="5"/>): This option enables you to view a graphical heat map of all the KPIs in the level you are currently on. For more information, see [Visualization](/end-user/basic-navigation/visualization#view-as-kpi-map).
6. **View as Group Map** (<SvgFont icon="141"/>): This view is similar to the **View as KPI Map** but is more advanced and gives each Group its status. For more information, see [Visualization](/end-user/basic-navigation/visualization#view-as-group-map).
7. **View as Group Map Table** (<SvgFont icon="21"/>): This View shows groups as titles in a table. For more information, see [Visualization](/end-user/basic-navigation/visualization#view-as-group-map-table).
8. **View as Geo Map** (<SvgFont icon="264"/>): This option combines the latitude and longitude of your assets and Google Maps to create an interactive visualization right inside the Visual KPI. For more information, see [Visualization](/end-user/basic-navigation/visualization#view-as-geo-map).
...
Want to know more about Group visualization? Access the [Visualization](/end-user/features/visualizations/overview) page to learn the basics of the different visualizations for your Groups and KPIs.