...
title: Profiles
slug: profiles
description: Learn how to create, customize, and switch profiles in Visual KPI to personalize dashboards, bookmarks, and watchlists for individual or group use.
tags: ['basic-navigation', 'quick-start', 'end-user', 'profiles', 'customization']
---

<head>
  <title>Profiles</title>
  <meta name="keywords" content="Visual KPI, profiles, end-user guide, profile customization, dashboards, bookmark bar, watchlist, profile groups, public profiles, private profiles, create profiles, change profiles, user settings, personalized dashboards, profile management, locked profiles"/>
</head>
