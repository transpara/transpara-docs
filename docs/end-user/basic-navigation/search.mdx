...
title: Search
slug: search
description: Learn how to use Visual KPI's live search to find dashboards, KPIs, groups, charts, and tables, and create Ad Hoc trends for data visualization.
tags: ['basic-navigation', 'quick-start', 'end-user', 'search', 'KPI-management', 'ad-hoc-groups', 'visualizations']
---

<head>
  <title>Search</title>
  <meta name="keywords" content="Visual KPI, search feature, end-user guide, live search, object search, dashboard search, KPI search, group search, chart search, table search, trend search, ad hoc groups, create ad hoc, visualization tools, data retrieval, KPI management, search training"/>
</head>
