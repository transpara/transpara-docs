...
title: Analytics
slug: analytics
description: Learn how to use Visual KPI's analytics tools, including Ad Hoc Trends, to analyze KPIs, identify patterns, and make data-driven decisions.
tags: ['basic-navigation', 'quick-start', 'end-user', 'analytics', 'data-visualization', 'ad-hoc-trend', 'KPI-analysis', 'training-materials']
---

<head>
  <title>Analytics</title>
  <meta name="keywords" content="Visual KPI, KPI analytics, Ad Hoc Trend, data visualization, KPI patterns, predictive analytics, forecasting, trend tools, KPI list view, offset trends, custom trend building, analytics training, KPI attributes, dashboard trends, end-user guide, trend configuration"/>
</head>
