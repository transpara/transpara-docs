...
title: Browser
slug: browser
description: Explore the core browsing concepts of Visual KPI, including sidebar tools, quick start options, and dashboard customization for streamlined KPI management.
tags: ['core-concepts', 'quick-start', 'end-user', 'navigation']
---

<head>
  <title>Browser</title>
  <meta name="keywords" content="Visual KPI, browser navigation, core concepts, end-user guide, quick start tools, KPI browsing, group navigation, charts, tables, dashboard customization, breadcrumbs, watchlist, timestamp, sidebar tools"/>
</head>
