...
The KPI detail view includes a new icon that lets users switch from the standard hierarchical drill-down to an influencer view, which highlights KPIs that have a direct impact on the selected metric.
