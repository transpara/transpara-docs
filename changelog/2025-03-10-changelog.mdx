...
- **Influencer KPIs:**  
  Added the ability to identify which metrics most strongly influence others. This feature automatically creates links to these influencer KPIs for drill-down analysis. Check the documentation for [Influencer KPIs](/end-user/features/visualizations/kpis#view-influencer-kpis).
